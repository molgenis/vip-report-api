...
function mapSex(dbValue: string): Person["sex"] {
        switch (dbValue) {
            case "UNKNOWN": return "UNKNOWN_SEX";
            case "FEMALE": return "FEMALE";
            case "MALE": return "MALE";
            case "OTHER": return "OTHER_SEX";
            default: throw new Error(`Invalid sex value: ${dbValue}`);
        }
    }
    ...
    function mapAffectedStatus(dbValue: string): Person["affectedStatus"] {
        switch (dbValue) {
            ...
            default: throw new Error(`Invalid affectedStatus value: ${dbValue}`);
        }
    }