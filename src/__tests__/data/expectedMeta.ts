...
const data: VcfMetadata = {
  ...
  info: {
    ...
    CSQ: {
      description: "Consequence annotations from Ensembl VEP. Format: Allele|VIPC|IS",
      id: "CSQ",
      label: "CSQ",
      nested: {
        items: {
  ...
  lines: [
    ...
    '##INFO=<ID=CSQ,Number=.,Type=String,Description="Consequence annotations from Ensembl VEP. Format: Allele|VIPC|IS">',
    '##INFO=<ID=SELECT,Number=1,Type=String,Description="Reserved.">',
    ...
    '##FORMAT=<ID=AS,Number=1,Type=String,Description="Reserved.">',
    "##contig=<ID=chr2,length=1234>",
    "##contig=<ID=chr10,length=1234>",
